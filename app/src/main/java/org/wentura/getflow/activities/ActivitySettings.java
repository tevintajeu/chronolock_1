...
import static org.wentura.getflow.activities.ActivitySettings.WindowType.SESSIONS_BEFORE_LONG_BREAK;
import static org.wentura.getflow.activities.ActivitySettings.WindowType.WORK_DURATION;
...
//        enableDNDOnBreaksSwitch = findViewById(R.id.enable_do_not_disturb_on_breaks_switch);
        ...
        workDurationGroup.setOnClickListener(view ->
                setupDialog(getString(R.string.work_duration_title), WORK_DURATION));
...
//                        database.activityDao().setKeepDNDOnBreaks(activityId, enableDNDOnBreaksSwitch.isChecked())));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.edit_name_button) {
                ...
                return true; }
            else if(item.getItemId() == R.id.delete_button){                Database.databaseExecutor.execute(() -> {
